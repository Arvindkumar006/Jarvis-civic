...
- STREETLIGHT_OUTAGE -> PWD_ROADS
- GARBAGE_ACCUMULATION -> PWD_ROADS
- WATER_SUPPLY_ISSUE -> DRAINAGE_STORMWATER
- ELECTRICITY_OUTAGE -> PWD_ROADS
- PUBLIC_INFRASTRUCTURE_DAMAGE -> PWD_ROADS
- OTHER_CIVIC_ISSUE -> PWD_ROADS
